...
<i18n lang="yaml">
  en:
    ...
    mobileid: Mobile-ID
    email: E-Mail
    info: "This website uses OAuth to enable users to authenticate and connect their accounts with third-party services. By using OAuth, you agree to share your account information, including your name, email address, profile picture, and other relevant details with these services.
  ...
  et:
    ...
    mobileid: Mobiil-ID
    email: E-post
    info: "See veebisait kasutab OAuth-i, et võimaldada kasutajatel autentida ja ühendada oma kontod kolmandate teenustega. Kasutades OAuth-i, nõustute oma konto teabe, sealhulgas nime, e-posti aadressi, profiilipildi ja muude asjakohaste üksikasjadega nende teenustega jagamisega.
